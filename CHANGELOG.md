...
[Full Changelog](https://github.com/nubisproject/nubis-db-admin/compare/v2.3.0...v2.3.1)

**Closed issues:**

- Tag v2.3.0 release [\#82](https://github.com/nubisproject/nubis-db-admin/issues/82)
- Tag v2.3.1 release [\#85](https://github.com/nubisproject/nubis-db-admin/issues/85)

**Merged pull requests:**

- Update CHANGELOG for v2.3.1 release \[skip ci\] [\#87](https://github.com/nubisproject/nubis-db-admin/pull/87) ([nubis-automation](https://github.com/nubis-automation))
- Update CHANGELOG for v2.3.1 release \[skip ci\] [\#86](https://github.com/nubisproject/nubis-db-admin/pull/86) ([nubis-automation](https://github.com/nubis-automation))
